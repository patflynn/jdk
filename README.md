...
| `openjdk-jre-17` `openjdk-jre-17-20221115` `openjdk-jre-17.0` `openjdk-jre-17.0.5` `openjdk-jre-17.0.5.8` `openjdk-jre-17.0.5.8-r1` | `sha256:646487155084e2304efa039dd0dbe8201c5955e45b14e190cb7b8d7e9ae4476c`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:646487155084e2304efa039dd0dbe8201c5955e45b14e190cb7b8d7e9ae4476c) | `amd64` |
...
| `latest` `openjdk-17` `openjdk-17-20221115` `openjdk-17.0` `openjdk-17.0.5` `openjdk-17.0.5.8` `openjdk-17.0.5.8-r1` | `sha256:b0d30e21c3c593ff4d4e4a8b20ab610d44dae5d8e83e5b9f159870741393a314`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:b0d30e21c3c593ff4d4e4a8b20ab610d44dae5d8e83e5b9f159870741393a314) | `amd64` |
| `openjdk-11` `openjdk-11-20221115` `openjdk-11.0` `openjdk-11.0.17` `openjdk-11.0.17.8` `openjdk-11.0.17.8-r1` | `sha256:76c9a1ff17f7aeab5bafe945f6954bbc093ade7b7a3e7d8bbf234eb42bff8b3d`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:76c9a1ff17f7aeab5bafe945f6954bbc093ade7b7a3e7d8bbf234eb42bff8b3d) | `amd64` |
...
| `openjdk-jre-11` `openjdk-jre-11-20221115` `openjdk-jre-11.0` `openjdk-jre-11.0.17` `openjdk-jre-11.0.17.8` `openjdk-jre-11.0.17.8-r1` | `sha256:05ce3cbc597eaf514fade581152eca7fc59c260c32b365b2fda24e4d90c62f45`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:05ce3cbc597eaf514fade581152eca7fc59c260c32b365b2fda24e4d90c62f45) | `amd64` |
...
[
  {
    "critical": {
      ...
      "image": {
        "docker-manifest-digest": "sha256:b0d30e21c3c593ff4d4e4a8b20ab610d44dae5d8e83e5b9f159870741393a314"
      },
    ...
    "optional": {
      ...
      "1.3.6.1.4.1.57264.1.3": "b4054b6dadeaffe0cd74cd2742f6ee6db5207721",
      "1.3.6.1.4.1.57264.1.4": ".github/workflows/release.yaml",
      "1.3.6.1.4.1.57264.1.5": "chainguard-images/images",
      "1.3.6.1.4.1.57264.1.6": "refs/heads/main",
      "Bundle": {
        "SignedEntryTimestamp": "MEUCIGonO8pgaGjp8VdX81FSDRgY2GDL4y0xwXpFGPv9/3/WAiEAo6vkxswc4WLVof49+KOxmujJdeZpWM6ergQke38kQFE=",
        "Payload": {
          "body": "",
          "integratedTime": 1668474160,
          "logIndex": 7093376,
      ...
      "githubWorkflowSha": "b4054b6dadeaffe0cd74cd2742f6ee6db5207721",
      "githubWorkflowTrigger": "schedule",
      "run_attempt": "1",
      "run_id": "3466506145",
      "sha": "b4054b6dadeaffe0cd74cd2742f6ee6db5207721"
    }
  }
]
```
