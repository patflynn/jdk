...
| Tag | Digest | Arch |
| --- | ------ | ---- |
| `latest` `openjdk-17` `openjdk-17-20221118` `openjdk-17.0` `openjdk-17.0.5` `openjdk-17.0.5.8` `openjdk-17.0.5.8-r1` | `sha256:0f246d54b12f507881368a602d533963e047d5b2382c08c442f9e9b7e56613af`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:0f246d54b12f507881368a602d533963e047d5b2382c08c442f9e9b7e56613af) | `amd64` |
...
| `openjdk-jre-17` `openjdk-jre-17-20221118` `openjdk-jre-17.0` `openjdk-jre-17.0.5` `openjdk-jre-17.0.5.8` `openjdk-jre-17.0.5.8-r1` | `sha256:0525d1e282f427c84582a6471a76ba8cae62e9405bdeb7bad9077866ab1706cb`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:0525d1e282f427c84582a6471a76ba8cae62e9405bdeb7bad9077866ab1706cb) | `amd64` |
...
| `openjdk-jre-11` `openjdk-jre-11-20221118` `openjdk-jre-11.0` `openjdk-jre-11.0.17` `openjdk-jre-11.0.17.8` `openjdk-jre-11.0.17.8-r1` | `sha256:bf5fd3bd5613d89900784a360858b0a04362e3ed544fa4c6027df6ae350cfed4`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:bf5fd3bd5613d89900784a360858b0a04362e3ed544fa4c6027df6ae350cfed4) | `amd64` |
...
| `openjdk-11` `openjdk-11-20221118` `openjdk-11.0` `openjdk-11.0.17` `openjdk-11.0.17.8` `openjdk-11.0.17.8-r1` | `sha256:f6b5e33fc77673cacfa2a49ee5a59d5f8ac3b5042de91edfaeff272d08de25bd`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:f6b5e33fc77673cacfa2a49ee5a59d5f8ac3b5042de91edfaeff272d08de25bd) | `amd64` |
...
[
  {
    "critical": {
      ...
      "image": {
        "docker-manifest-digest": "sha256:0f246d54b12f507881368a602d533963e047d5b2382c08c442f9e9b7e56613af"
      },
    ...
    "optional": {
      ...
      "1.3.6.1.4.1.57264.1.3": "f4e7eee61ef95dfb4af25b7b3a24fc6221c34770",
      "1.3.6.1.4.1.57264.1.4": ".github/workflows/release.yaml",
      "1.3.6.1.4.1.57264.1.5": "chainguard-images/images",
      "1.3.6.1.4.1.57264.1.6": "refs/heads/main",
      "Bundle": {
        "SignedEntryTimestamp": "MEQCIFeAONUsHhA0d7n7iFu9yEpbQJRiOSVH2YzqtXTOaLBlAiBSvVoMHoivoxGJLxBAoJGDxIX0yUlok5SY6Tow8HC54w==",
        "Payload": {
          "body": "",
          "integratedTime": 1668812777,
          "logIndex": 7376882,
      ...
      "githubWorkflowSha": "f4e7eee61ef95dfb4af25b7b3a24fc6221c34770",
      "githubWorkflowTrigger": "push",
      "run_attempt": "1",
      "run_id": "3500839652",
      "sha": "f4e7eee61ef95dfb4af25b7b3a24fc6221c34770"
    }
  }
]
```
