...
| `latest` `openjdk-17` `openjdk-17-20221116` `openjdk-17.0` `openjdk-17.0.5` `openjdk-17.0.5.8` `openjdk-17.0.5.8-r1` | `sha256:c5818101591e3c08a563d2a88f1be20c7599670698007d65664004ebdfd20ed1`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:c5818101591e3c08a563d2a88f1be20c7599670698007d65664004ebdfd20ed1) | `amd64` |
...
| `openjdk-jre-11` `openjdk-jre-11-20221116` `openjdk-jre-11.0` `openjdk-jre-11.0.17` `openjdk-jre-11.0.17.8` `openjdk-jre-11.0.17.8-r1` | `sha256:6b034a84a4d116cec96d01f756ee5c18b6deb97ed7ec7c3385a3a2331779eaf7`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:6b034a84a4d116cec96d01f756ee5c18b6deb97ed7ec7c3385a3a2331779eaf7) | `amd64` |
...
| `openjdk-jre-17` `openjdk-jre-17-20221116` `openjdk-jre-17.0` `openjdk-jre-17.0.5` `openjdk-jre-17.0.5.8` `openjdk-jre-17.0.5.8-r1` | `sha256:5ac5aa958f61897d14bfe71af431206a3f834a5bffc4c88cfe75ae5ccc1d40de`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:5ac5aa958f61897d14bfe71af431206a3f834a5bffc4c88cfe75ae5ccc1d40de) | `amd64` |
...
| `openjdk-11` `openjdk-11-20221116` `openjdk-11.0` `openjdk-11.0.17` `openjdk-11.0.17.8` `openjdk-11.0.17.8-r1` | `sha256:8ae240b3476c7061dbe5ac9fa0f9cb2545a7bfa58d39e53814e9c4dde4c08bca`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:8ae240b3476c7061dbe5ac9fa0f9cb2545a7bfa58d39e53814e9c4dde4c08bca) | `amd64` |
...
[
  {
    "critical": {
      ...
      "image": {
        "docker-manifest-digest": "sha256:c5818101591e3c08a563d2a88f1be20c7599670698007d65664004ebdfd20ed1"
      },
    ...
    "optional": {
      ...
      "1.3.6.1.4.1.57264.1.3": "1940ef4a7907a80656ec93fd5ec91f6d7bec580c",
      "1.3.6.1.4.1.57264.1.4": ".github/workflows/release.yaml",
      "1.3.6.1.4.1.57264.1.5": "chainguard-images/images",
      "1.3.6.1.4.1.57264.1.6": "refs/heads/main",
      "Bundle": {
        "SignedEntryTimestamp": "MEUCIGH71Pfv75FJzz6F6ksJEWnnLh4oszc3NTawpatJB/SXAiEA305OP98tqIy7UWVNHc2H3Z2WG10a/7CkviZTWsQ2rDU=",
        "Payload": {
          "body": "",
          "integratedTime": 1668560639,
          "logIndex": 7168559,
      ...
      "githubWorkflowSha": "1940ef4a7907a80656ec93fd5ec91f6d7bec580c",
      "githubWorkflowTrigger": "schedule",
      "run_attempt": "1",
      "run_id": "3475473694",
      "sha": "1940ef4a7907a80656ec93fd5ec91f6d7bec580c"
    }
  }
]
```
