...
| `openjdk-jre-11` `openjdk-jre-11-20221120` `openjdk-jre-11.0` `openjdk-jre-11.0.17` `openjdk-jre-11.0.17.8` `openjdk-jre-11.0.17.8-r1` | `sha256:de74bc075747f22c1f4b84eac9cd516218ec1201440e3420dd84b1a91255f051`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:de74bc075747f22c1f4b84eac9cd516218ec1201440e3420dd84b1a91255f051) | `amd64` |
...
| `openjdk-jre-17` `openjdk-jre-17-20221120` `openjdk-jre-17.0` `openjdk-jre-17.0.5` `openjdk-jre-17.0.5.8` `openjdk-jre-17.0.5.8-r1` | `sha256:76b54bbfc671765541c6645ef98f00f04aa47ffd4449fd3292cc6219f72da7bb`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:76b54bbfc671765541c6645ef98f00f04aa47ffd4449fd3292cc6219f72da7bb) | `amd64` |
...
| `latest` `openjdk-17` `openjdk-17-20221120` `openjdk-17.0` `openjdk-17.0.5` `openjdk-17.0.5.8` `openjdk-17.0.5.8-r1` | `sha256:046d26fb14f374ef905892313a2637c26541d6b84eb88e6e85b200f78be690a9`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:046d26fb14f374ef905892313a2637c26541d6b84eb88e6e85b200f78be690a9) | `amd64` |
| `openjdk-11` `openjdk-11-20221120` `openjdk-11.0` `openjdk-11.0.17` `openjdk-11.0.17.8` `openjdk-11.0.17.8-r1` | `sha256:ece7406cb154b813c706e96de228f5e80ff3b89b4c60b6a31ac4013240e929ff`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:ece7406cb154b813c706e96de228f5e80ff3b89b4c60b6a31ac4013240e929ff) | `amd64` |
...
[
  {
    "critical": {
      ...
      "image": {
        "docker-manifest-digest": "sha256:046d26fb14f374ef905892313a2637c26541d6b84eb88e6e85b200f78be690a9"
      },
    ...
    "optional": {
      ...
      "Bundle": {
        "SignedEntryTimestamp": "MEUCIQCsV8yPMoqn36OqnBt/iAN2M5ic7DfN7I0opE00lzFDngIgTsCjJ8Vv1MKv9LAuwaRB+oznj+WWXE5/8mXShsWBDJs=",
        "Payload": {
          "body": "",
          "integratedTime": 1668906388,
          "logIndex": 7448908,
